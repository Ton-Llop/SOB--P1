...
<html>
    ...
    <body>
        ...
        <%
            ...
            "INSERT INTO " + schema + ".ARTICLE (id, title, content, isprivate, publicationdate, views, image, author) VALUES (NEXT VALUE FOR ARTICLE_GEN, 'Primer article', 'Contingut del primer article',true, CURRENT_TIMESTAMP, 10, 'imatge1',3)",
